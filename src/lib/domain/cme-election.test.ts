  ...
  it('CT-918b: assertDirection deve disparar StructureDirectionError se as pernas forem invertidas', () => {
    const invertedStrategy: ElectedOptionStrategy = {
      strategySpec: {
        ...
        originalName: 'Long Call Spread',
        category: 'Direcional',
        bias: 'ALTA',
        difficulty: 'Intermediário',
        legsDescription: 'Comprar Call strike A e vender Call strike B (A < B)',
        whenToUse: 'Alta moderada',
        profitProfile: 'Limitado',
        lossProfile: 'Limitado ao prêmio pago',
        timeDecayProfile: 'Misto',
