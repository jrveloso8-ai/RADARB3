...
function writeFile(relPath, content) {
  ...
  console.log('Created View: ' + relPath);
}
...
// 2. Footer
writeFile('src/components/layout/Footer.tsx', `
import React from 'react';
...
fs.writeFileSync('c:/Projetos Antigravity/TESTE_BRAPI/build_react_views.js', fs.readFileSync('c:/Projetos Antigravity/TESTE_BRAPI/build_react_views.js', 'utf8') || '', 'utf8');
