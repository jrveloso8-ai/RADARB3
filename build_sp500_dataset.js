...
// 500 Tickers and Company Names of the S&P 500
const sp500Raw = [
  // Tech & Communication
...
// Complete dataset generator that fills out full quantitative metrics for each stock
const fullDatasetCode = `
...
export const US_STOCKS_DATASET: USStockItem[] = ${JSON.stringify(
  sp500Raw.map(item => {
...
console.log('Full S&P 500 Market Dataset created successfully with ' + sp500Raw.length + ' stocks');
